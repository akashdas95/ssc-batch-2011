...
//     try{
//       await axios.post("http://localhost:8000/students/"+id, data);
//       navigate("/");
//     }catch(err){
//       console.log(err);
//     }
...
//         <input name="name" value={students.name} placeholder='Enter your name' onChange={handleChange} className='p-1 m-1 bg-green-200 text-start hover:bg-green-100'/>
//         <select name="school_name" value={students.school_name} onChange={handleChange} className='m-1 p-1 border-1 border-black bg-green-50 hover:cursor-pointer'>
...
//         </select>
//         {schoolOpen&&<input name="school_name" value={students.school_name} placeholder='Enter your School name' onChange={handleChange} className='p-1 m-1 bg-green-200 text-start hover:bg-green-100' />} 
//         <input name="email" value={students.email} placeholder='Enter your Email (optional)' onChange={handleChange} className='p-1 m-1 bg-green-200 text-start hover:bg-green-100' />
//         <input name="phone" value={students.phone} placeholder='Enter your phone no (optional)' onChange={handleChange} className='p-1 m-1 bg-green-200 text-start hover:bg-green-100'/>
//         <input name="facebook" value={students.facebook} placeholder='Enter your facebook id (optional)' onChange={handleChange} className='p-1 m-1 bg-green-200 text-start hover:bg-green-100'/>
//         <input name="instagram" value={students.instagram} placeholder='Enter your instagram id (optional)' onChange={handleChange}  className='p-1 m-1 bg-green-200 text-start hover:bg-green-100'/>
